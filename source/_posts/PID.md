...
模拟通过单环PID输出角速度来控制电机角度，因为是模拟，故假定角速度可以突变
...
![](https://kakaluoto-hexo-blog.oss-cn-guangzhou.aliyuncs.com/img/202303171431787.png)

目标值设置成随时间变化`pid_controller.set_target(np.pi * np.sin(i / 10))`

![](https://kakaluoto-hexo-blog.oss-cn-guangzhou.aliyuncs.com/img/202303171440340.png)
